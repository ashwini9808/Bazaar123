            ...
            <div className=' container mx-auto px-4 mt-5 '>
                <div className="p-5 rounded-lg bg-gray-100 drop-shadow-xl border border-gray-200"
                    ...
                    <div className="flex items-center justify-between mt-4">
                        ...
                        <button className="px-4 py-2 bg-gray-50hover:bg-gray-200 text-gray-800 border-2 text-sm font-medium rounded-md hover:bg-gray-300" style={{ color: mode === 'dark' ? 'white' : '' }}
