...
function Signup() {
  ...
  return (
    <div className=" flex justify-center items-center m-10 bg-gradient-to-t from-blue-400">
      {loading && <Loader />}

      <img src={shape3} alt="img" className="animate-bounce " />

      <div className="  bg-gray-300 px-20 py-20 rounded-xl border-gray-500 border-2 shadow-lg ">
        <div className="">
          <h1 className="text-center text-black text-3xl mb-14 font-bold">
            Sign Up
          </h1>
        </div>
        <div>
