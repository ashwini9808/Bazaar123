...
function Cart() {
  ...
  const grandTotal = totalAmount < 300  ? (shipping + totalAmount) : totalAmount;
  ...
  return (
    <Layout >
      <div className=" bg-gray-100 pt-5 mb-auto " style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          ...
          <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
            ...
            <div className="flex justify-between">
              ...
              <p className="text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>₹{totalAmount > 300 ? '0' : shipping}</p>
